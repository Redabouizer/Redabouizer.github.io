  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        ...
        <span>
          {/* UPDATED LinkedIn link with the provided URL */}
          <a href="https://www.linkedin.com/in/reda-bouizergane/" target="_blank">
            <FaLinkedinIn />
          </a>
        </span>
        <span>
          {/* X (Twitter) link with the provided URL */}
          <a href="https://x.com/RedaBouizergane" target="_blank">
            <FaXTwitter />
          </a>
        </span>
        <span>
          {/* Instagram link with the provided URL */}
